...
const char* call_to_string(BOOL client, UINT32 interfaceKey, UINT32 functionId)
{
	const UINT32 mask = (interfaceKey & STREAM_ID_MASK) >> 30;
	const UINT32 interfaceId = interfaceKey & INTERFACE_ID_MASK;
