...
LONG smartcard_pack_state_return(SMARTCARD_DEVICE* smartcard, wStream* s, const State_Return* ret)
{
	...
	if (!smartcard_ndr_pointer_write(s, (UINT32 *)&index, ret->cbAtrLen))
		return SCARD_E_NO_MEMORY;
                                      ...
                                      const GetAttrib_Return* ret, DWORD dwAttrId)
{
	...
	if (!smartcard_ndr_pointer_write(s, (UINT32 *)&index, ret->cbAttrLen))
		return SCARD_E_NO_MEMORY;
                                   ...
                                   const Control_Return* ret)
{
	...
	if (!smartcard_ndr_pointer_write(s, (UINT32 *)&index, ret->cbOutBufferSize))
		return SCARD_E_NO_MEMORY;
                                        ...
                                        const LocateCards_Return* ret)
{
	...
	if (!smartcard_ndr_pointer_write(s, (UINT32 *)&index, ret->cReaders))
		return SCARD_E_NO_MEMORY;
                                           ...
                                           const GetReaderIcon_Return* ret)
{
	...
	if (!smartcard_ndr_pointer_write(s, (UINT32 *)&index, ret->cbDataLen))
		return SCARD_E_NO_MEMORY;
